...
namespace LTE.MultiProcessController
{
    public partial class CtrlForm : Form
    {
        ...
        private List<MMFReRayStruct> MultiTasksReRay;
        ...
        public CtrlForm()
        {
            ...
            this.MultiTasksReRay = new List<MMFReRayStruct>();
        ...
        private bool dealParams(string[] args)
        {
            ...
            {
                MessageBox.Show("参数个数不匹配，程序退出:" + args.Length);
            }
            return false;
        }
        ...
        {
            //MessageBox.Show("F:startChildPro()");
            Random r = new Random(DateTime.Now.Second);
            LTE.Geometric.Point p = cellInfo.SourcePoint;
            double deltaA = (this.toAngle - this.fromAngle + 360) % 360 / processNum;
            //deltaA = 40;
            double from, to;
            //double[] fromto = {190, 230, 280, 305, 330};
            //double[] fromto = { 190, 250, 300, 330 };
            //double[] fromto = { 240, 260, 280};
            //double[] fromto = { 190, 330 };
            string calcBids = "";
            ...
            {
                // (450-oldAngle)%360;
                //double fromAngle1 = GeometricUtilities.ConvertGeometricArithmeticAngle(toAngle + 1);
                //double toAngle1 = GeometricUtilities.ConvertGeometricArithmeticAngle(fromAngle - 1);
                ...
                for (int i = 0; i < this.processNum; i++)
                {
                    ...
                    //MessageBox.Show(string.Format("{0} {1}", from, to));
        ...
        /// <summary>
        /// 旧方法，因为MainWindowHandle为空的原因现已废弃
        /// </summary>
        ...
        //        if (!pa.pro.HasExited)
        //        {
        //            IPC.PostMessage(pa.pro.MainWindowHandle, IPC.WM_POST_NOTIFY, this.Handle, 0);
        //            Console.WriteLine(string.Format("启动子进程{0}计算...\tchild handle: {1}, mmf name: {2}", i+1, pa.pro.MainWindowHandle, pa.MMFName));
        //        }
        //    }
        //}
        ...
        private void startCalc(IntPtr handle)
        {
            ...
            this.paList.Add(pa);
            //MessageBox.Show("IPC.WM_POST_NOTIFY");
            
            IPC.PostMessage(handle, IPC.WM_POST_NOTIFY, this.Handle, 0);
            //MessageBox.Show("子进程{0} ready, mmf name: {1}, 启动计算...");
