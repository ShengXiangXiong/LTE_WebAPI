...
namespace LTE.GIS
{
    ...
    /// 刷新图层
    /// </summary>
    public class RefreshLayerClass
    {
        /// <summary>
        /// 刷新GSM图层(包含900,1800及基站图层)
        /// </summary>
        public void RefreshGSMLayers()
        {
            //RefreshGSM900BTS();
            RefreshGSM900Cell();
            //RefreshGSM1800BTS();
        ...
        public void RefreshGSM900Cell()
        {
            ...
            foreach (CELL gsm900Cell in GSM900CellData)
            {
                ...
                double radius = gsm900Cell.CoverageRadius==null?0: gsm900Cell.CoverageRadius.Value;
                tilt = tilt > 0 ? tilt : 7;
