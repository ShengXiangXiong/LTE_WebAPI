...
namespace LTE.GIS
{
	...
	public sealed class Pan :BaseTool
	{
		...
		public Pan()
		{
			...
			{
				base.m_bitmap = new System.Drawing.Bitmap(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.pan.bmp"));
			}
			m_pCursorStop = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.HAND.CUR"));
			m_pCursorMove = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.movehand.cur"));
