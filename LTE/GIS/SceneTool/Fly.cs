...
namespace LTE.GIS
{
	...
	public sealed class Fly : BaseTool 
	{
		...
		public Fly()
		{
			...
			{
				base.m_bitmap = new System.Drawing.Bitmap(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.fly.bmp"));
			}
			m_flyCur = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.fly.cur"));
			m_moveFlyCur = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.fly1.cur"));
		...
		public void StartFlight()
		{
			...
			//Determine the elevation and azimut in radians and
		...
		public void Flight()
		{
			...
			do
			{
				...
				//Set elevation and azimut in radians for normal rotation
