...
namespace LTE.GIS
{
	...
	public sealed class ZoomIn : BaseTool
	{
		...
		public ZoomIn()
		{
			...
			{
				base.m_bitmap = new System.Drawing.Bitmap(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.ZoomIn.bmp"));
			}
			m_pCursor = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.ZoomIn.cur"));
