...
namespace LTE.GIS.SceneTool
{
	...
	public sealed class SelectGraphics : BaseTool
	{
		...
		public SelectGraphics()
		{
			...
			{
				base.m_bitmap = new System.Drawing.Bitmap(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.select.bmp"));
			}
			m_pCursor = new System.Windows.Forms.Cursor(GetType().Assembly.GetManifestResourceStream("LTE.GIS.SceneTool.selectGraphics.cur"));
