...
namespace LTE.GIS
{
    public static class GeometryUtilities
    {
        ...
        /// <returns></returns>
        public static List<LTE.Geometric.Point> SmoothBuildingPoints(ref List<LTE.Geometric.Point> bpoints)
        {
            List<LTE.Geometric.Point> ret = new List<LTE.Geometric.Point>();
            //if (bpoints == null) return ret;
            //LTE.Geometric.Point prePoint = new LTE.Geometric.Point(0, 0, 0), curPoint;
            ...
            SmoothBuildingVertex sbv = new SmoothBuildingVertex();
            ret = sbv.Process(ref bpoints);
