...
namespace LTE.InternalInterference.Grid
{
    ...
    public class BuildingGrid3D
    {
        ...
        // 2019.7.20 建筑物栅格还未划分时，根据范围和中心点得到建筑物中心点
        ...
        /// 平滑处理
        /// </summary>
        public static void constructBuildingVertexOriginal(Object pageParam=null)
        {
            maxBID = int.MinValue;
            minBID = int.MaxValue;
        ...
        */
        ...
        public static Dictionary<int, TriangleBound> getShelterDisAndAngleBeam(Point source, List<int> buildingids, double baseHeight)
        {
            ...
            {
                bid = buildingids[i];
                //Console.WriteLine("buildingHeight.Count: {0}", buildingHeight.Count);
                height = buildingHeight[bid];
